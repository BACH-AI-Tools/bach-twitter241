...
if API_KEY:
    ...
    default_headers["X-RapidAPI-Host"] = "twitter241.p.rapidapi.com"
else:
...
async def _add_rapidapi_headers(method, url, **kwargs):
    ...
    if API_KEY:
        ...
        kwargs['headers']['X-RapidAPI-Host'] = "twitter241.p.rapidapi.com"
    else:
